...
<nav className="bg-light-color border-gray-200 dark:bg-black ">
  <div className="lg:max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
   ...
   <div className={` w-full lg:flex lg:w-[85%] justify-between  ${isopen?'block':'hidden'}`} id="navbar-default" >
...
<ul className=" font-medium flex flex-col p-4 lg:p-0 mt-4 border lg:flex-row lg:space-x-3 rtl:space-x-reverse lg:mt-0 lg:border-0 ">
 ...
 {isLogin?  <li onClick={()=>{setOpen(false)}}>
...
<i className="fa-solid fa-user text-[1.3rem]"></i>
 ...
 {isLogin? <li onClick={logout}>
    <a onClick={()=>{setOpen(false)}} href="#" className="block py-2 px-3 text-slate-500 hover:text-green-color dark:text-white dark:hover:text-green-500 transition-all focus:text-green-color dark:focus:text-green-color  ">Logout</a>
  </li>:
  ...
  <li>
  <i className='block py-2 px-3 text-slate-500 hover:text-red-500  dark:text-white dark:hover:text-red-500 transition-all fa-brands fa-instagram'></i>
  </li>
  <li>
    <i className='block py-2 px-3 text-slate-500 hover:text-red-700 dark:text-white dark:hover:text-red-700 transition-all fa-brands fa-youtube'></i>
  </li>
  <li>
    <i className='block py-2 px-3 text-slate-500 hover:text-blue-600 dark:text-white dark:hover:text-blue-600 transition-all fa-brands fa-facebook'></i>
  </li>
  <li>
